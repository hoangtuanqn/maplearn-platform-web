...
const savedCourses = [
    ...
    },
    {
        ...
        teacher: "Thầy Vũ Ngọc Anh",
        thumbnail:
            "https://mapstudy.sgp1.digitaloceanspaces.com/course/wohur3e041cp/lap-trinh-tu-duy-tu-truong-va-hat-nhan-1727339175338.jpg",
        ...
        <section className="min-h-screen">
            <ProfileContentLayout title="Khoá học đã lưu">
                {savedCourses.length === 0 ? (
                    <DisplatNoData title="Bạn chưa lưu khoá học nào" />
                ) : (
