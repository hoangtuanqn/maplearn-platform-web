    ...
    return (
        ...
        >
            ...
            <div className="flex flex-col gap-1 py-4">
                <Link to={ROUTE_PATHS.user.profile}>
                    <div
                        className={`flex w-full cursor-pointer items-center gap-3 rounded-lg px-3 py-2 duration-100 ${
                            isActiveRoute(ROUTE_PATHS.user.profile) ? "bg-primary text-white" : "hover:bg-gray-100"
                        }`}
                    >
                        <div className="t1-flex-center w-6">
                            <svg className="h-5 w-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none">
                                <path
                                    ...
                                    stroke={isActiveRoute(ROUTE_PATHS.user.profile) ? "#ffffff" : "var(--primary)"}
                                    strokeWidth={2}
                                    strokeLinecap="round"
                        ...
                        <svg className="h-5 w-5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path
                                ...
                                stroke={isActiveRoute(ROUTE_PATHS.user.profile) ? "#ffffff" : "#9c9c9c"}
                                strokeWidth={2}
                                strokeMiterlimit={10}
                                strokeLinecap="round"
                                strokeLinejoin="round"
                ...
                <Link to={ROUTE_PATHS.user.myCourses}>
                    <div
                        className={`flex w-full cursor-pointer items-center gap-3 rounded-lg px-3 py-2 duration-100 ${
                            isActiveRoute(ROUTE_PATHS.user.myCourses) ? "bg-primary text-white" : "hover:bg-gray-100"
                        }`}
                    >
                        <div className="t1-flex-center w-6">
                            <svg className="h-5 w-5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path
                                    ...
                                    stroke={isActiveRoute(ROUTE_PATHS.user.myCourses) ? "#ffffff" : "var(--primary)"}
                                    strokeWidth={2}
                                    strokeLinecap="round"
                                    strokeLinejoin="round"
                                />
                        ...
                        <svg className="h-5 w-5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path
                                d="M8.91003 19.9201L15.43 13.4001C16.2 12.6301 16.2 11.3701 15.43 10.6001L8.91003 4.08008"
                                stroke={isActiveRoute(ROUTE_PATHS.user.myCourses) ? "#ffffff" : "#9c9c9c"}
                                strokeWidth={2}
                                strokeMiterlimit={10}
                                strokeLinecap="round"
                                strokeLinejoin="round"
                ...
                <Link to={ROUTE_PATHS.user.savedCourses}>
                    <div
                        className={`flex w-full cursor-pointer items-center gap-3 rounded-lg px-3 py-2 duration-100 ${
                            isActiveRoute(ROUTE_PATHS.user.savedCourses) ? "bg-primary text-white" : "hover:bg-gray-100"
                        }`}
                    >
                        <div className="t1-flex-center w-6">
                            <svg
                            ...
                            >
                                <path
                                    ...
                                    fill={isActiveRoute(ROUTE_PATHS.user.savedCourses) ? "#ffffff" : "var(--primary)"}
                                />
                            </svg>
                        </div>
                        ...
                        <svg className="h-5 w-5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path
                                d="M8.91003 19.9201L15.43 13.4001C16.2 12.6301 16.2 11.3701 15.43 10.6001L8.91003 4.08008"
                                stroke={isActiveRoute(ROUTE_PATHS.user.savedCourses) ? "#ffffff" : "#9c9c9c"}
                                strokeWidth={2}
                                strokeMiterlimit={10}
                                strokeLinecap="round"
                                strokeLinejoin="round"
                ...
                <Link to={ROUTE_PATHS.user.savedQuestions}>
                    <div
                        className={`flex w-full cursor-pointer items-center gap-3 rounded-lg px-3 py-2 duration-100 ${
                            isActiveRoute(ROUTE_PATHS.user.savedQuestions)
                    ...
                    >
                        <div className="t1-flex-center w-6">
                            ...
                            >
                                <path
                                    ...
                                    fill={isActiveRoute(ROUTE_PATHS.user.savedQuestions) ? "#ffffff" : "var(--primary)"}
                                />
                            </svg>
                        </div>
                        ...
                        <svg className="h-5 w-5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path
                                d="M8.91003 19.9201L15.43 13.4001C16.2 12.6301 16.2 11.3701 15.43 10.6001L8.91003 4.08008"
                                stroke={isActiveRoute(ROUTE_PATHS.user.savedQuestions) ? "#ffffff" : "#9c9c9c"}
                                strokeWidth={2}
                                strokeMiterlimit={10}
                                strokeLinecap="round"
                                strokeLinejoin="round"
                ...
                <Link to={ROUTE_PATHS.user.receivedItems}>
                    <div
                        className={`flex w-full cursor-pointer items-center gap-3 rounded-lg px-3 py-2 duration-100 ${
                            isActiveRoute(ROUTE_PATHS.user.receivedItems)
                                ? "bg-primary text-white"
                                : "hover:bg-gray-100"
                        }`}
                    >
                        <div className="t1-flex-center w-6">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" className="h-5.5 w-5.5">
                                <path
                                    fill="none"
                                    stroke={
                                        isActiveRoute(ROUTE_PATHS.user.receivedItems) ? "#ffffff" : "var(--primary)"
                                    }
                                    strokeLinecap="round"
                                    strokeLinejoin="round"
                                    strokeWidth={3}
                        ...
                        <svg className="h-5 w-5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path
                                d="M8.91003 19.9201L15.43 13.4001C16.2 12.6301 16.2 11.3701 15.43 10.6001L8.91003 4.08008"
                                stroke={isActiveRoute(ROUTE_PATHS.user.receivedItems) ? "#ffffff" : "#9c9c9c"}
                                strokeWidth={2}
                                strokeMiterlimit={10}
                                strokeLinecap="round"
                                strokeLinejoin="round"
