...
const NotFound = () => {
    return (
        <div className="flex w-full flex-col items-center justify-center" style={{ minHeight: "calc(100vh - 56px)" }}>
            <div className="bg-gradient-to-r from-[#CB356B] to-[#CB356B] bg-clip-text text-[64px] font-bold text-transparent xl:text-[130px] 2xl:text-[150px]">
                404
            </div>
            <div className="mt-[-16px] ml-2 text-xl font-bold xl:mt-[-40px] xl:text-2xl">Trang không tồn tại</div>
            <Link
