        ...
        <div className="px-4 lg:px-0">
            <div className="flex w-full flex-row gap-6">
                <div className="w-full lg:flex-[2]">
                    <div className="main-block min-h-[calc(60vh-56px-63px)] rounded-lg p-4 shadow-sm">
                            ...
                            >
                                ...
                                <div className="flex flex-1 flex-col justify-between">
                                    <div className="flex flex-col gap-1">
                                        <p className="line-clamp-1 font-medium text-[#373737]">
                                    ...
                                    <div className="border-t-[1px] border-t-[#E3E3E3] pt-2.5">
                                        <div className="flex items-center justify-between">
                                            <div className="flex items-center gap-1">
                                                ...
                                                <p className="text-[#656C7B]">1597</p>
                                            </div>
                                            <div className="flex items-center gap-1">
                                                <svg
                                                    width="18"
                                                ...
                                                <p className="text-[#656C7B]">17/06/2025</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                <div className="hidden flex-1 rounded-lg lg:block">
                    <div className="relative h-full">
                        ...
                        <div className="sticky w-full" style={{ top: "76px" }}>
                            <div className="main-block rounded-lg !p-5.5 p-4 shadow-sm">
